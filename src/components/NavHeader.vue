          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                ...
                <input type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input" placeholder="UserName">
              </li>
